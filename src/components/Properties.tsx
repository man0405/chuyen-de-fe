                    ...
                    <div className="mt-8">
                        <div className="flex items-center gap-4 mb-6 bg-gray-100 p-4 rounded-lg">
                            <div className="flex items-center gap-2">
                                ...
                                <span>4</span>
                                <span className="text-muted-foreground underline cursor-pointer">(1 Review)</span>
                            </div>
                            <span className="bg-red-500 text-white text-sm px-2 py-1 rounded">POPULAR</span>
                        ...
                        <p className="text-muted-foreground mb-6">
                            Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum. Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi. Nam eget dui etiam rhoncus maecenas tempus tellus eget.
                        </p>
                        <p className="text-muted-foreground mb-8">
                            Nullam quis ante tiam sit amet orci eget eros faucibus tincidunt. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim.
                        </p>
                    </div>
                    ...
                    <div className="mb-12">
                        ...
                        <div className="relative w-full h-[400px] rounded-lg overflow-hidden mb-4">
                            ...
                            <div className="absolute top-4 left-4 z-10">
                                <button className="bg-white w-8 h-8 flex items-center justify-center rounded-sm shadow-md mb-2">+</button>
                                <button className="bg-white w-8 h-8 flex items-center justify-center rounded-sm shadow-md">−</button>
                            </div>
                        </div>
                        ...
                        <div className="mb-8">
                            ...
                            <div className="flex flex-wrap gap-3">
                                <span className="px-4 py-2 bg-gray-100 rounded-full text-sm">Colorful</span>
                                <span className="px-4 py-2 bg-gray-100 rounded-full text-sm">Diamond</span>
                                <span className="px-4 py-2 bg-gray-100 rounded-full text-sm">House</span>
                                <span className="px-4 py-2 bg-gray-100 rounded-full text-sm">Luxury</span>
                                <span className="px-4 py-2 bg-gray-100 rounded-full text-sm">Luxury Living</span>
                                <span className="px-4 py-2 bg-gray-100 rounded-full text-sm">Rental Property</span>
                            </div>
                        </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex justify-between items-start mb-2">
                                            ...
                                            <span className="text-muted-foreground text-sm">8 November, 2024</span>
                                        </div>
                                        <p className="text-muted-foreground">
                                            It was amazing and I'll book it again soon, Every thing was perfect except the water of bathroom was little hot.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="mb-8">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                {[
                                    ...
                                    <div key={listing.id} className="bg-white rounded-md overflow-hidden shadow-sm">
                                        <div className="relative">
                                            <Image
                                                src={listing.image}
                                                alt={listing.title}
                                            ...
                                            />
                                            <span className="absolute top-2 left-2 bg-red-500 text-white px-2 py-0.5 text-xs rounded">POPULAR</span>
                                        ...
                                        <div className="p-3">
                                            <div className="flex items-center gap-1 mb-1">
                                                <div className="flex text-yellow-400 text-xs">
                                                    {[...Array(5)].map((_, i) => (
                                                        <span key={i} className={i < listing.rating ? "" : "text-gray-300"}>⭐</span>
                                                    ))}
                                                </div>
                                                <span className="text-muted-foreground text-xs">{listing.rating} ({listing.reviews})</span>
                                            </div>

                                            <h3 className="text-base font-semibold mb-1">{listing.title}</h3>
                                            <p className="text-muted-foreground text-xs mb-2">{listing.description}</p>
                                            ...
                                            <div className="flex justify-between items-center">
                                                <span className="text-red-500 text-base font-bold">{listing.price}</span>
                        ...
                        <CardContent className="p-6">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">Member since 4 months ago</p>
                                </div>
                            </div>
                        ...
                        <CardContent className="p-6">
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <p className="text-muted-foreground">22 Broklyn Street New York USA</p>
                                </div>
                                <div>
