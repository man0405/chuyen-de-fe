        ...
        <Card className="overflow-hidden group">
            <div className="relative">
                ...
                <div className="absolute top-3 right-3">
                    <Button variant={"outline"} className="   rounded-full  transition-colors">
                        <Heart />
                    </Button>
                </div>
                <div className="absolute bottom-4 left-4  shadow-2xl border rounded-full bg-secondary border-white">
            ...
            <CardFooter className=" p-3 flex justify-between items-center border-t">
                <span className="font-bold text-base sm:text-lg text-orange">{price}</span>
                <Button variant="outline" size="sm" className="text-xs h-8 sm:text-sm">
                    View Details
                </Button>
            </CardFooter>
        </Card>
