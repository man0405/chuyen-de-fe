  ...
  return (
    <Card className="overflow-hidden group">
      <div className="relative">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
          <div className="p-4 md:p-6 w-full">
            <Button variant={"secondary"} className="p-0 justify-center w-full">
              <Link
                href={"/agents"}
                className="py-2 w-full px-3 rounded-md flex items-center justify-center text-sm"
              >
                <Phone className="h-3 w-3 md:h-4 md:w-4 mr-1 md:mr-2" /> Contact
                Agent
              </Link>
            </Button>
          </div>
        ...
        <div className="absolute top-3 right-3">
          <span className="dark:text-slate-800 text-slate-200 px-2 py-0.5 md:px-3 md:py-1 rounded-full border shadow-orange-200 text-xs">
      ...
      <CardContent className="p-3 md:p-4 text-center">
        <h3 className="font-bold text-base md:text-lg mb-0.5 md:mb-1">
          {name}
        </h3>
